...
## Objectives
>Explore different methods of spatial Autocorrelation
...
plot(v$x, v$y)
#uf<- curl("#need to add my 500 data")
...
```{r}
#Moran's I
unif.moran <- correlog(coordinates(unif.spdf), v$att, method = "Moran", nbclass = NULL, alternative = "two.sided")
# Can view the textual results by simply typing 'random.moran'
...
I dont want to do this with 500 points, so I am going to cut it down to 500 for now
```{r}
